...
class CamApp(App):
    ...
    def build(self):
        ...
        self.capture = cv2.VideoCapture(1)  # for me it's "1", adjust your webcams/cameras
    ...
    def update(self, dt):
        ...
        texture_new = Texture.create(size=(image.shape[1], image.shape[0]), colorfmt='luminance')
